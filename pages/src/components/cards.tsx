  ...
  const handleClick = () => {
   ...
   return (
     <div className={styles.container}>
       <a className={`${styles.arrows} ${styles.arrowleft}`} type="button" onClick={handleClick}></a>
       <a className={`${styles.arrows} ${styles.arrowright}`} type="button" onClick={handleClick}></a>
