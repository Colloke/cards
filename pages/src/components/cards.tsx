...
const Cards = () => {
  const handleClick = () => {
    // Set new className to the card
  };
   return (
     <div className={styles.container}>
          <div>
            <a className={`${styles.arrows} ${styles.arrowleft}`} role="button" onClick={handleClick}></a>
            <a className={`${styles.arrows} ${styles.arrowright}`} role="button" onClick={handleClick}></a>
           </div>
